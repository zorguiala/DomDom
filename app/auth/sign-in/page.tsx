    ...
    try {
      ...
      if (result?.error) {
        ...
        // Handle cases where result is ok but no specific error (should not happen often with redirect:false)
         setError(t("signInErrorUnexpected") || "An unexpected error occurred during sign in.");
      }
    } catch (err) {
      ...
      toast({
        variant: "destructive",
        title: t("signInErrorTitle") || "Sign In Error",
        description: t("signInErrorUnexpected") || "An unexpected error occurred.",
      });
    } finally {
      setIsLoading(false);
    }
      ...
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
            {t("accessYourDashboard") || "Access your ERP dashboard and manage your business"}
          </p>
        </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center space-x-2">
                  ...
                  />
                  <span className="text-sm text-gray-600 dark:text-gray-400">{t("rememberMe") || "Remember me"}</span>
                </label>
                <Link
              ...
              <Button
                ...
                disabled={isLoading}
              >
                {isLoading ? commonT("loading") || "Signing in..." : t("signInButton") || "Sign in"}
              </Button>
            </form>
