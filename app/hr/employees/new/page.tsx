...
export default function AddEmployeePage() {
  ...
  const {
    ...
    defaultValues: {
      ...
      department: "",
      position: "",
      salary: null, // Or undefined, depending on how you want to handle empty number input
      hireDate: "",
      isActive: true,
    },
  });
  ...
  const onSubmit = async (data: EmployeeFormData) => {
    try {
      ...
      toast({
        ...
        description:
          t("employeeCreatedDesc", { name: data.name }) ||
          `Employee ${data.name} has been successfully created.`,
      });
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="flex justify-end space-x-3 pt-4">
              ...
              <Button type="submit" disabled={isSubmitting}>
                ...
                {isSubmitting ? common("creating") : t("createEmployeeButton")}
              </Button>
            </div>
          </form>
        </CardContent>
