...
export default function ProductionOrderDetailPage() {
  ...
  if (!order) return <div className="text-center p-4">{t("orderNotFound")}</div>;

  return (
    <div className="flex-1 space-y-6 p-4 md:p-8 pt-6">
      <div className="flex items-center justify-between space-y-2">
        <h2 className="text-3xl font-bold tracking-tight">{t("productionOrderDetailsTitle")} - {order.orderNumber}</h2>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>{t("orderNumber")}: {order.orderNumber}</CardDescription>
        </CardHeader>
            ...
            <Table>
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead className="text-right">{t("totalRequired")}</TableHead>
              ...
              <TableBody>
                {order.bom.components.map((component) => (
                  <TableRow key={component.id}>
                    ...
                    <TableCell className="text-right">{component.quantity * order.qtyOrdered}</TableCell>
                    <TableCell>{component.unit || component.product.unit}</TableCell>
                  </TableRow>
                ))}
              </TableBody>
            </Table>
