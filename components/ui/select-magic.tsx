...
const baseStyles = "block w-full rounded border border-gray-300 bg-white px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500";

export const SelectMagic = React.forwardRef<
  HTMLSelectElement,
...
SelectMagic.displayName = "SelectMagic";

export const InputMagic = React.forwardRef<
  HTMLInputElement,
...
InputMagic.displayName = "InputMagic"; 