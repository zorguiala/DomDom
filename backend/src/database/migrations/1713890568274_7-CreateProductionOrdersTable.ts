...
export class CreateProductionOrdersTable1713890568274_7 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."production_orders_priority_enum" AS ENUM('low', 'medium', 'high')`
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "production_orders" ADD CONSTRAINT "FK_68140cdf831e1bc9cfa8e285c8e" FOREIGN KEY ("assignedToId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
    await queryRunner.query(
      `ALTER TABLE "production_orders" ADD CONSTRAINT "FK_d3fb1ddebdc091837735af3d3f5" FOREIGN KEY ("createdById") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "production_orders" DROP CONSTRAINT "FK_d3fb1ddebdc091837735af3d3f5"`
    );
    await queryRunner.query(
      `ALTER TABLE "production_orders" DROP CONSTRAINT "FK_68140cdf831e1bc9cfa8e285c8e"`
    );
    await queryRunner.query(
