...
export class InventoryEntitiesUpdate1714791748125 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`UPDATE "inventory_transaction" SET "productId" = "product"."id" FROM "product" WHERE "inventory_transaction"."productId" IS NULL AND "inventory_transaction"."productId" = "product"."id"`);
        
        // Add foreign key constraint
        await queryRunner.query(`ALTER TABLE "inventory_transaction" ADD CONSTRAINT "FK_inventory_transaction_product" FOREIGN KEY ("productId") REFERENCES "product"("id")`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        // Remove foreign key constraint
        await queryRunner.query(`ALTER TABLE "inventory_transaction" DROP CONSTRAINT "FK_inventory_transaction_product"`);
