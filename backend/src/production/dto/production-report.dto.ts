...
export class ProductionStatisticsDto extends ReportPeriodDto {
  ...
  @ApiProperty({ description: 'Filter by employee ID', example: '123e4567-e89b-12d3-a456-426614174000', required: false })
  @IsUUID()
  @IsOptional()
  employeeId?: string;
  ...
  @ApiProperty({ description: 'Group by', example: 'daily', required: false, enum: ['daily', 'weekly', 'monthly'] })
...
export class ExportReportDto extends ProductionStatisticsDto {
  ...
  @ApiProperty({ description: 'Report title', example: 'Production Report - January 2023', required: false })
  @IsString()
  @IsOptional()
  title?: string;
}
